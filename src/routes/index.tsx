...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    { title: "QuizTime Go — Le jeu de quiz pour tout le monde" },
    { name: "description", content: "QuizTime Go : apprends en jouant. Un jeu de quiz ouvert à tous, particulièrement adapté aux étudiants et aux passionnés de connaissance. Gagne de l'XP, monte de niveau et grimpe au classement." },
    { property: "og:title", content: "QuizTime Go — Apprendre devient un jeu" },
    { property: "og:description", content: "Entre dans le lobby futuriste de QuizTime Go : quiz, combos, XP, badges, défis entre amis et Haïti Quest." },
  ] }),
  component: Lobby,
});
