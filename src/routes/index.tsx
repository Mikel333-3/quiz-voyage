...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    { title: "Quiz Time — Le jeu de quiz pour tout le monde" },
    { name: "description", content: "Quiz Time : apprends en jouant. Un jeu de quiz ouvert à tous, particulièrement adapté aux étudiants et aux passionnés de connaissance. Gagne de l'XP, monte de niveau et grimpe au classement." },
    { property: "og:title", content: "Quiz Time — Apprendre devient un jeu" },
    { property: "og:description", content: "Entre dans le lobby futuriste de Quiz Time : quiz, combos, XP, badges, défis entre amis et Haïti Quest." },
  ] }),
  component: Lobby,
});
