/**
 * Données de démonstration (mock) de Quiz Time.
...
export const GAME_MODES: GameMode[] = [
  ...
  },
  {
    ...
    description: "15 secondes par question. Rapidité = points bonus.",
    icon: "timer",
    accent: "success",
    timePerQuestion: 15,
    xpMultiplier: 1.5,
  },
  {
    ...
    description: "Format sérieux, temps limité, résultat détaillé.",
    icon: "graduation",
    accent: "violet",
    timePerQuestion: 30,
    xpMultiplier: 1.3,
  },
  {
    ...
    description: "Le système choisit matière, niveau et difficulté.",
    icon: "dice",
    accent: "warning",
    timePerQuestion: 20,
    xpMultiplier: 1.7,
  },
  {
    ...
    description: "Histoire, géographie, culture et patrimoine d'Haïti.",
    icon: "flag",
    accent: "haiti",
    timePerQuestion: 20,
    xpMultiplier: 1.6,
...
export const QUESTIONS: Question[] = [
  {
    id: "m1",
    subject: "maths",
    prompt: "Quelle est la valeur de x dans l'équation 2x + 5 = 17 ?",
    answers: ["x = 6", "x = 11", "x = 7", "x = 12"],
    correctIndex: 0,
    explanation: "2x = 17 - 5 = 12, donc x = 6.",
  },
  {
    id: "m2",
    subject: "maths",
    prompt: "Combien font 15 % de 200 ?",
    answers: ["15", "20", "30", "35"],
    correctIndex: 2,
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: "Périmètre = 4 × 7 = 28 cm.",
  },
  {
    id: "m4",
    subject: "maths",
  ...
  },
  {
    id: "m5",
    subject: "maths",
    prompt: "Si un triangle a des angles de 60° et 70°, quel est le troisième ?",
    answers: ["40°", "50°", "60°", "70°"],
    correctIndex: 1,
  ...
  },
  {
    ...
    answers: ["Chevals", "Chevaux", "Chevales", "Chevaus"],
    correctIndex: 1,
  ...
  },
  {
    id: "f2",
    subject: "francais",
    prompt: "Dans « Il court vite », quelle est la nature de « vite » ?",
    answers: ["Adjectif", "Adverbe", "Nom", "Pronom"],
    correctIndex: 1,
    explanation: "« Vite » modifie le verbe : c'est un adverbe.",
  },
  {
    id: "f3",
    subject: "francais",
    prompt: "Quel temps : « Nous avions mangé » ?",
    answers: ["Passé composé", "Plus-que-parfait", "Imparfait", "Futur antérieur"],
    correctIndex: 1,
  ...
  },
  {
    id: "f4",
    subject: "francais",
    prompt: "Qui a écrit « Gouverneurs de la rosée » ?",
    answers: ["Jacques Roumain", "Jacques Stephen Alexis", "René Depestre", "Frankétienne"],
    correctIndex: 0,
    explanation: "Jacques Roumain, publié en 1944.",
  },
  {
    id: "p1",
    subject: "physique",
  ...
  },
  {
    id: "p2",
    subject: "physique",
    prompt: "La vitesse de la lumière dans le vide est d'environ :",
    answers: ["3 × 10⁸ m/s", "3 × 10⁶ m/s", "1 500 m/s", "340 m/s"],
    correctIndex: 0,
    explanation: "Environ 300 000 km/s.",
  },
  {
    id: "p3",
    subject: "physique",
    prompt: "Quel état de la matière a un volume propre mais pas de forme propre ?",
    answers: ["Solide", "Liquide", "Gaz", "Plasma"],
    correctIndex: 1,
    explanation: "Le liquide prend la forme de son contenant.",
  },
  {
    id: "s1",
    subject: "sciences",
    prompt: "Quel gaz les plantes absorbent-elles pour la photosynthèse ?",
    answers: ["Oxygène", "Azote", "Dioxyde de carbone", "Hydrogène"],
    correctIndex: 2,
    explanation: "Elles absorbent le CO₂ et rejettent de l'oxygène.",
  },
  {
    id: "s2",
    subject: "sciences",
    prompt: "Quel organe pompe le sang dans le corps humain ?",
    answers: ["Le foie", "Le cœur", "Les poumons", "Les reins"],
    correctIndex: 1,
  ...
  },
  {
    id: "s3",
    subject: "sciences",
    prompt: "Quel est le plus grand risque naturel majeur en Haïti ?",
    answers: ["Tornades", "Séismes et cyclones", "Éruptions", "Blizzards"],
    correctIndex: 1,
    explanation: "Haïti se situe sur des failles actives et sur la route des cyclones.",
  },
  {
    id: "k1",
    subject: "creole",
    prompt: "Ki sa « konesans » vle di an franse ?",
    answers: ["Courage", "Connaissance", "Confiance", "Conscience"],
    correctIndex: 1,
    explanation: "« Konesans » = connaissance.",
  },
  {
    id: "k2",
    subject: "creole",
    prompt: "An ki ane kreyòl vin yon lang ofisyèl an Ayiti ?",
    answers: ["1964", "1987", "1991", "2004"],
    correctIndex: 1,
    explanation: "Konstitisyon 1987 la rekonèt kreyòl kòm lang ofisyèl.",
  },
  {
    id: "h1",
    subject: "histoire",
    category: "Histoire",
    prompt: "En quelle année Haïti a-t-elle proclamé son indépendance ?",
    answers: ["1791", "1803", "1804", "1806"],
    correctIndex: 2,
    explanation: "Le 1er janvier 1804, aux Gonaïves.",
  },
  {
    id: "h2",
    subject: "histoire",
    category: "Histoire",
    prompt: "Qui a proclamé l'indépendance d'Haïti ?",
    answers: [
    ...
    correctIndex: 1,
    explanation: "Jean-Jacques Dessalines, premier chef d'État haïtien.",
  },
  {
    id: "h3",
    subject: "histoire",
    category: "Patrimoine",
    prompt: "Quel monument haïtien est classé au patrimoine mondial de l'UNESCO ?",
    answers: ["Le Palais Sans-Souci", "La Citadelle Laferrière", "Le Marché en Fer", "Les deux premiers"],
    correctIndex: 3,
    explanation: "Le Parc national historique inclut la Citadelle et Sans-Souci.",
  },
  {
    id: "h4",
    subject: "histoire",
    category: "Géographie",
    prompt: "Combien de départements compte Haïti ?",
    answers: ["8", "9", "10", "12"],
    correctIndex: 2,
  ...
  },
  {
    ...
    subject: "histoire",
    category: "Géographie",
    prompt: "Quel est le point culminant d'Haïti ?",
    answers: ["Pic Macaya", "Morne la Selle", "Morne Cabaio", "Chaîne des Matheux"],
    correctIndex: 1,
    explanation: "Le Morne la Selle, environ 2 680 m.",
  },
  {
    id: "h6",
    subject: "histoire",
    category: "Culture",
    prompt: "Quel plat est traditionnellement mangé le 1er janvier en Haïti ?",
    answers: ["Soup joumou", "Diri kole", "Tchaka", "Legim"],
    correctIndex: 0,
    explanation: "La soupe au giraumon, symbole de la liberté.",
  },
  {
    id: "h7",
    subject: "histoire",
    category: "Institutions",
    prompt: "Quelles sont les couleurs du drapeau haïtien ?",
    answers: ["Bleu et rouge", "Rouge et noir", "Bleu et blanc", "Vert et rouge"],
    correctIndex: 0,
    explanation: "Bleu et rouge, avec les armes de la République.",
  },
  {
    id: "h8",
    subject: "histoire",
    category: "Personnalités",
    prompt: "Qui est surnommé « le Précurseur » de l'indépendance haïtienne ?",
    answers: ["Vincent Ogé", "Toussaint Louverture", "Boukman", "Capois-La-Mort"],
    correctIndex: 1,
    explanation: "Toussaint Louverture, le Précurseur.",
  },
];
...
export function questionsFor(
  ...
  let pool = QUESTIONS.filter((q) =>
    subject === "haiti"
      ? q.subject === "histoire" || q.category !== undefined
      : q.subject === subject,
  );
  if (category) {
