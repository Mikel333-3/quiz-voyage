...
import { EXTRA_QUESTIONS_3 } from "./question-bank-3";
...
const EXTRA_QUESTIONS_2_BASE: TaggedQuestion[] = [
...
export const EXTRA_QUESTIONS_2: TaggedQuestion[] = [...EXTRA_QUESTIONS_2_BASE, ...EXTRA_QUESTIONS_3];
